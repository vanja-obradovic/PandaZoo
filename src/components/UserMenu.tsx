...
const UserMenu = ({
  ...
  return (
    <div className="relative">
      <button
        className="rounded-[50%] bg-orange-100 lg:text-3xl text-xl p-3 cursor-pointer btn-ghost hover:bg-orange-200 active:scale-90 transition-transform ease-in-out duration-100 relative aspect-square"
